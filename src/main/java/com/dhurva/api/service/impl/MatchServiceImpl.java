package com.dhurva.api.service.impl;

import com.dhurva.api.entity.Match;
import com.dhurva.api.repository.MatchRepo;
...
//                update the match in database
    ...
    private void updateMatch(Match match){
        Match match1 = this.matchRepo.findByTeamHeading(match.getTeamHeading()).orElse(null);
